...
class Emojifier {
    ...
    private static void getClassifications(Face face) {
        Log.d(LOG_TAG, "Smile Probabillity: " + face.getIsSmilingProbability());
        Log.d(LOG_TAG, "Left Eye Open Probabillity: " + face.getIsLeftEyeOpenProbability());
        Log.d(LOG_TAG, "Right Eye Open Probabillity: " + face.getIsRightEyeOpenProbability());
    }
}
